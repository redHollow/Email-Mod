...
if(isset($_POST['email_data']))
{
	...
	foreach($_POST['email_data'] as $row)
	{
		...
		$mail->Username = 'atakorusammy@gmail.com';					//Sets SMTP username
		$mail->Password = 'S@mmy123!!';					//Sets SMTP password
		$mail->SMTPSecure = '';							//Sets connection prefix. Options are "", "ssl" or "tls"
		$mail->From = 'atakorusammy@gmail.com';			//Sets the From email address for the message
